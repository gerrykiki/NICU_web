...
class Nurtionorder extends Component {
    render() {
        ...
        return (
            <div style={{ width: "100%" }}>
                ...
                <div style={{ marginTop: "10px" }}>
                    <div style={{ backgroundColor: "rgba(255, 249, 237, 1)", display: 'grid', gridTemplateColumns: "1fr 2fr 1fr 1fr 1.5fr", height: '50px' }}>
                        <div style={{ display: "flex", alignItems: "center", justifyContent: "center" }}>開立時間</div>
                        <div style={{ display: "flex", alignItems: "center", justifyContent: "center" }}>處置名稱</div>
                        ...
                        <div style={{ display: "flex", alignItems: "center", justifyContent: "center" }}>開立醫師</div>
                    </div>
                    <div style={{ maxHeight: "70vh", overflowY: "auto" }}>
                        <div style={{ display: 'grid', gridTemplateColumns: "1fr 5.5fr", height: '80px' }}>
